...
```{r isle6_3_04, message=F, warning=F}
...
```{r isle6_3_06, message=F, warning=F}
# load packages
library(partykit)
library(tidyverse)
# create data
...
```{r isle6_3_45, message=F, warning=F}
...
```{r isle6_3_47, message=F, warning=F}
...
```{r isle6_3_51, message=F, warning=F}
library (multcomp)
...
```{r isle6_3_56, message=F, warning=F}
...
```{r isle6_3_59, message=F, warning=F}
