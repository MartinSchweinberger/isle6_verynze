...
The AIC of the glmer object is substantially smaller which indicates that including the random intercepts appears to be justified. We continue by specifying the optimizer and adding a first fixed predictor (Age).
